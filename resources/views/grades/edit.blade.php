<x-app-layout>
    ...
    <form method="POST" action="{{ route('grades.update', $grade) }}" class="mt-6 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <x-text-input id="grade" name="grade" type="text" class="mt-1 block w-full" :value="old('grade', $grade->grade)" required autocomplete="grade" />
